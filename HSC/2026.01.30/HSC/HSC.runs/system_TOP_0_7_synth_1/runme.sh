...
HD_PWD='E:/HSC_PRO/HSC/HSC.runs/system_TOP_0_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_TOP_0_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_TOP_0_7.tcl
