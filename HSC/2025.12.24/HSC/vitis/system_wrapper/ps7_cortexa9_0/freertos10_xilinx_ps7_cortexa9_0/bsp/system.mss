...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ps_pl_axi4
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ps_pl_axi4_0
END
...
BEGIN LIBRARY
 ...
 PARAMETER socket_mode_thread_prio = 8
 PARAMETER tcp_snd_buf = 102400
 PARAMETER tcp_wnd = 102400
