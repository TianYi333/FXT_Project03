...
# IP: bd/system/ip/system_axis_data_fifo_0_2/system_axis_data_fifo_0_2.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_axis_data_fifo_0_2 || ORIG_REF_NAME==system_axis_data_fifo_0_2} -quiet] -quiet
...
# IP: bd/system/ip/system_Sim_ad_data_gen_0_0/system_Sim_ad_data_gen_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_Sim_ad_data_gen_0_0 || ORIG_REF_NAME==system_Sim_ad_data_gen_0_0} -quiet] -quiet
...
# XDC: d:/ASUS-PC/Desktop/temporary/AXI_Stream/AXI_Stream_test/AXI_Stream_test.gen/sources_1/bd/system/system_ooc.xdc
