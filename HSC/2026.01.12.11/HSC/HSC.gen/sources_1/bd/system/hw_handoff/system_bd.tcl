...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set AD_CTRL1_0 [ create_bd_port -dir O AD_CTRL1_0 ]
  set AD_CTRL2_0 [ create_bd_port -dir O AD_CTRL2_0 ]
  set AD_CTRL3_0 [ create_bd_port -dir O AD_CTRL3_0 ]
  set AD_DA_0 [ create_bd_port -dir I -from 13 -to 0 AD_DA_0 ]
  set AD_DB_0 [ create_bd_port -dir I -from 13 -to 0 AD_DB_0 ]
  set AD_RESET_0 [ create_bd_port -dir O -type rst AD_RESET_0 ]
  set AD_SCLK_0 [ create_bd_port -dir O AD_SCLK_0 ]
  set AD_SDATA_0 [ create_bd_port -dir O AD_SDATA_0 ]
  set AD_SEN_0 [ create_bd_port -dir O AD_SEN_0 ]
  set ad_clk_in_0 [ create_bd_port -dir I ad_clk_in_0 ]
  set clk_ad_out_0 [ create_bd_port -dir O clk_ad_out_0 ]
  set clk_dir_0 [ create_bd_port -dir O clk_dir_0 ]
  set clk_in_0 [ create_bd_port -dir I clk_in_0 ]
  set triger_in_pos_0 [ create_bd_port -dir I triger_in_pos_0 ]
  set triger_in_tr_0 [ create_bd_port -dir I triger_in_tr_0 ]
...
0}\
  ...
  connect_bd_intf_net -intf_net TOP_0_m_axis [get_bd_intf_pins TOP_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net AD_DA_0_1 [get_bd_ports AD_DA_0] [get_bd_pins TOP_0/AD_DA]
  connect_bd_net -net AD_DB_0_1 [get_bd_ports AD_DB_0] [get_bd_pins TOP_0/AD_DB]
  connect_bd_net -net TOP_0_AD_CTRL1 [get_bd_ports AD_CTRL1_0] [get_bd_pins TOP_0/AD_CTRL1]
  connect_bd_net -net TOP_0_AD_CTRL2 [get_bd_ports AD_CTRL2_0] [get_bd_pins TOP_0/AD_CTRL2]
  connect_bd_net -net TOP_0_AD_CTRL3 [get_bd_ports AD_CTRL3_0] [get_bd_pins TOP_0/AD_CTRL3]
  connect_bd_net -net TOP_0_AD_RESET [get_bd_ports AD_RESET_0] [get_bd_pins TOP_0/AD_RESET]
  connect_bd_net -net TOP_0_AD_SCLK [get_bd_ports AD_SCLK_0] [get_bd_pins TOP_0/AD_SCLK]
  connect_bd_net -net TOP_0_AD_SDATA [get_bd_ports AD_SDATA_0] [get_bd_pins TOP_0/AD_SDATA]
  connect_bd_net -net TOP_0_AD_SEN [get_bd_ports AD_SEN_0] [get_bd_pins TOP_0/AD_SEN]
  connect_bd_net -net TOP_0_clk_ad_out [get_bd_ports clk_ad_out_0] [get_bd_pins TOP_0/clk_ad_out]
  connect_bd_net -net TOP_0_clk_dir [get_bd_ports clk_dir_0] [get_bd_pins TOP_0/clk_dir]
  ...
  connect_bd_net -net triger_in_pos_0_1 [get_bd_ports triger_in_pos_0] [get_bd_pins TOP_0/triger_in_pos]
  connect_bd_net -net triger_in_tr_0_1 [get_bd_ports triger_in_tr_0] [get_bd_pins TOP_0/triger_in_tr]
  ...
  exclude_bd_addr_seg -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps_pl_axi4_0/S00_AXI/S00_AXI_reg]
