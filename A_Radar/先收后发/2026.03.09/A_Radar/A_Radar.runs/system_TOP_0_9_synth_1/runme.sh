...
HD_PWD='E:/A_Radar/A_Radar/A_Radar.runs/system_TOP_0_9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_TOP_0_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_TOP_0_9.tcl
