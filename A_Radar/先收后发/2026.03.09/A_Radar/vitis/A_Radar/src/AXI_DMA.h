...
#define MAX_PKT_LEN             1*1024*1024 //最大数据长度1MB
#define TOTAL_FRAME           	5000	//最大帧数
...
extern volatile uint32_t Target_Frame_Rate;//目标帧数
extern volatile uint8_t AD_Sampling_Time;//AD采样时间
