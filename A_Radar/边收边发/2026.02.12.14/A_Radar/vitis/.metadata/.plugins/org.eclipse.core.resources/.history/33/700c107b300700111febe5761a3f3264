...
//	xil_printf("PL_read_bytes= %d \r\n", PL_read_bytes);
    ...
    if(PL_read_bytes >= 0x20000000)//如果接收总数量大于等于512MB
    {
    	...
    	Tx_Axi_Stream_buf[1] = ((PL_read_bytes-last_Read_address)>>24)&0xff;//接收数据数
    	Tx_Axi_Stream_buf[2] = ((PL_read_bytes-last_Read_address)>>16)&0xff;//接收数据数
    	Tx_Axi_Stream_buf[3] = ((PL_read_bytes-last_Read_address)>>8)&0xff;//接收数据数
    	Tx_Axi_Stream_buf[4] = (PL_read_bytes-last_Read_address)&0xff;//接收数据数
