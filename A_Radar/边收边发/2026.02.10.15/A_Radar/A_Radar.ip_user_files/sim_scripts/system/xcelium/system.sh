...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../A_Radar.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../A_Radar.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"$ref_dir/../../../../A_Radar.gen/sources_1/bd/system/ipshared/8713/hdl" \
       +incdir+"../../../../A_Radar.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../A_Radar.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"../../../../A_Radar.gen/sources_1/bd/system/ipshared/8713/hdl" \
